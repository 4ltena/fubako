...
/**
 * 画面の骨。
 * - 狭いとき: 一列＋下の帯（デザイン案 1a〜1d）
 * - 768px から: 左に箱の一覧。下の帯は畳む
...
export default async function AppLayout({ children }: LayoutProps<"/">) {
  ...
  return (
    <>
      <div className="mx-auto flex w-full max-w-[1280px] justify-center md:justify-start md:gap-10 xl:gap-[30px]">
        <SideRail circles={memberships.map((m) => m.circle)} />
        <main className="w-full max-w-[592px] px-5 pb-32 pt-9 md:px-0 md:pb-16 md:pt-10">{children}</main>
